...
extension CollectionPolyTests {
    ...
    static let __allTests__CollectionPolyTests = [
        ...
        ("test_ElevenDifferentTypes", test_ElevenDifferentTypes),
        ("test_ElevenDifferentTypes_encode", test_ElevenDifferentTypes_encode),
...
extension PolyTests {
    ...
    static let __allTests__PolyTests = [
        ...
        ("test_init_Poly11", test_init_Poly11),
        ...
        ("test_Poly11_decode_throws_typeNotFound", test_Poly11_decode_throws_typeNotFound),
        ("test_Poly11_lookup", test_Poly11_lookup),
...
extension PolyTypeErasedValueTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__PolyTypeErasedValueTests = [
        ("test_poly0", test_poly0),
        ("test_poly1", test_poly1),
        ("test_poly10", test_poly10),
        ("test_poly11", test_poly11),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(PolyTypeErasedValueTests.__allTests__PolyTypeErasedValueTests),
